...
import com.eleme.view.BusinessView;
import com.eleme.view.FoodView;
import com.eleme.view.impl.BusinessViewImpl;
import com.eleme.view.impl.FoodViewImpl;
...
public class ElmBusinessEntry {
    public void work() {
        ...
        if(business!=null) {
            ...
            while(menu!=5) {
                //输出一级菜单
                System.out.println("\n======= 一级菜单（商家管理）1.查看商家信息=2.修改商家信息=3.更 新密码=4.所属商品管理=5.退出系统=======");
